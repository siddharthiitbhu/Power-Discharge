...
df_train = pd.read_csv('/content/drive/MyDrive/dataset_sid/metadata_train.csv')
...
def prep_data(start, end):
    ...
    praq_train = pq.read_pandas('/content/drive/MyDrive/dataset_sid/train.parquet', columns=[str(i) for i in range(start, end)]).to_pandas()
    X = []
    y = []
...
meta_test = pd.read_csv('/content/drive/MyDrive/dataset_sid/metadata_test.csv')
